...
//#endregion
//#region ../../node_modules/.pnpm/simplebar-react@3.3.2_react@19.2.8/node_modules/simplebar-react/dist/index.mjs
/**
...
var SimpleBar = React.forwardRef(function(_a, ref) {
	...
	return React.createElement("div", __assign({
		"data-simplebar": "init",
		ref: elRef
	}, rest), React.createElement("div", { className: classNames.wrapper }, React.createElement("div", { className: classNames.heightAutoObserverWrapperEl }, React.createElement("div", { className: classNames.heightAutoObserverEl })), React.createElement("div", { className: classNames.mask }, React.createElement("div", { className: classNames.offset }, typeof children === "function" ? children({
		scrollableNodeRef,
	...
	}) : React.createElement("div", __assign({}, scrollableNodeFullProps), React.createElement("div", { className: classNames.contentEl }, children)))), React.createElement("div", { className: classNames.placeholder })), React.createElement("div", { className: "".concat(classNames.track, " ").concat(classNames.horizontal) }, React.createElement("div", { className: classNames.scrollbar })), React.createElement("div", { className: "".concat(classNames.track, " ").concat(classNames.vertical) }, React.createElement("div", { className: classNames.scrollbar })));
});

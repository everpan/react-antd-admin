//#region ../../node_modules/.pnpm/pinyin-pro@3.29.3/node_modules/pinyin-pro/dist/esm/common/constant.mjs
...
//#endregion
//#region ../../node_modules/.pnpm/pinyin-pro@3.29.3/node_modules/pinyin-pro/dist/esm/common/utils.mjs
...
function splitString(text) {
	...
	if (!DoubleUnicodeReg.test(text)) return text.split("");
	const result = [];
	let i = 0;
	while (i < text.length) {
		const char = text[i];
...
//#endregion
//#region ../../node_modules/.pnpm/pinyin-pro@3.29.3/node_modules/pinyin-pro/dist/esm/data/special.mjs
var InitialList = [
	"zh",
	"ch",
	"sh",
...
//#endregion
//#region ../../node_modules/.pnpm/pinyin-pro@3.29.3/node_modules/pinyin-pro/dist/esm/data/dict1.mjs
var map = {
	"bǎng páng pāng": ["膀"],
	líng: [
		"〇",
...
//#endregion
//#region ../../node_modules/.pnpm/pinyin-pro@3.29.3/node_modules/pinyin-pro/dist/esm/core/custom/state.mjs
var customMultipleDict = new FastDictFactory();
var customPolyphonicDict = new FastDictFactory();
//#endregion
//#region ../../node_modules/.pnpm/pinyin-pro@3.29.3/node_modules/pinyin-pro/dist/esm/data/surname.mjs
var Surnames = {
	南宫: "nán gōng",
	第五: "dì wǔ",
	万俟: "mò qí",
...
//#endregion
//#region ../../node_modules/.pnpm/pinyin-pro@3.29.3/node_modules/pinyin-pro/dist/esm/core/pinyin/all.mjs
...
//#endregion
//#region ../../node_modules/.pnpm/pinyin-pro@3.29.3/node_modules/pinyin-pro/dist/esm/data/dict2.mjs
var DICT2 = {
	这个: "zhè ge",
	成为: "chéng wéi",
	认为: "rèn wéi",
...
//#endregion
//#region ../../node_modules/.pnpm/pinyin-pro@3.29.3/node_modules/pinyin-pro/dist/esm/data/dict3.mjs
var DICT3 = {
	为什么: "wèi shén me",
	实际上: "shí jì shang",
	检察长: "jiǎn chá zhǎng",
...
//#endregion
//#region ../../node_modules/.pnpm/pinyin-pro@3.29.3/node_modules/pinyin-pro/dist/esm/data/dict4.mjs
var DICT4 = {
...
//#endregion
//#region ../../node_modules/.pnpm/pinyin-pro@3.29.3/node_modules/pinyin-pro/dist/esm/data/dict5.mjs
var DICT5 = {
...
//#endregion
//#region ../../node_modules/.pnpm/pinyin-pro@3.29.3/node_modules/pinyin-pro/dist/esm/data/patterns.mjs
var PatternsNormal = [
	...Object.keys(DICT5).map((key) => ({
		zh: key,
		pinyin: DICT5[key],
		probability: 2e-8,
		length: 5,
...
//#endregion
//#region ../../node_modules/.pnpm/pinyin-pro@3.29.3/node_modules/pinyin-pro/dist/esm/common/segmentit/max-probability.mjs
...
function maxProbability(patterns, length) {
	...
	while (index < length) {
		const item = dp[index];
		if (item.pattern) result.push(item.pattern);
		index = item.nextIndex;
	}
	return result;
}
//#endregion
//#region ../../node_modules/.pnpm/pinyin-pro@3.29.3/node_modules/pinyin-pro/dist/esm/common/segmentit/min-tokenization.mjs
...
//#endregion
//#region ../../node_modules/.pnpm/pinyin-pro@3.29.3/node_modules/pinyin-pro/dist/esm/common/segmentit/reverse-max-match.mjs
...
//#endregion
//#region ../../node_modules/.pnpm/pinyin-pro@3.29.3/node_modules/pinyin-pro/dist/esm/common/segmentit/index.mjs
...
var AC = class {
	...
	addNodeToQueues(trieNode, depth) {
		if (!this.queues[depth]) this.queues[depth] = [];
	...
	search(text, surname, algorithm = 2, zhChars = splitString(text)) {
		...
		else if (algorithm === 3) return minTokenization(patterns, zhChars.length);
...
function scheduleAcBuild() {
	if (typeof requestIdleCallback === "function") requestIdleCallback(() => ensureAcBuilt());
	else setTimeout(ensureAcBuilt, 0);
}
scheduleAcBuild();
//#endregion
//#region ../../node_modules/.pnpm/pinyin-pro@3.29.3/node_modules/pinyin-pro/dist/esm/core/traditional/index.mjs
var traditionalDict = [];
...
//#endregion
//#region ../../node_modules/.pnpm/pinyin-pro@3.29.3/node_modules/pinyin-pro/dist/esm/core/pinyin/handle.mjs
...
function processReduplicationChar(cur, pre, _) {
	if (cur === "々") {
		if (!pre || !DICT1.get(pre)) return "tóng";
		else return DICT1.get(pre).split(" ")[0];
	}
}
function getProcessFuncs(text) {
	const processes = [];
	if (text.includes("々")) processes.push(processReduplicationChar);
...
//#endregion
//#region ../../node_modules/.pnpm/pinyin-pro@3.29.3/node_modules/pinyin-pro/dist/esm/core/pinyin/middlewares.mjs
...
function isNonZhScope(char, scope) {
	if (scope instanceof RegExp) {
		if (scope.global || scope.sticky) scope.lastIndex = 0;
...
var middlewareMultiple = (word, options) => {
	if (options.multiple && stringLength(word) === 1) return getMultiplePinyin(word, options.surname);
	else return false;
};
var middlewarePattern = (list, options) => {
	switch (options.pattern) {
		...
		case "finalBody":
			...
			break;
		case "finalTail": list.forEach((item) => {
...
//#endregion
//#region ../../node_modules/.pnpm/pinyin-pro@3.29.3/node_modules/pinyin-pro/dist/esm/core/pinyin/index.mjs
...
function pinyin(word, options) {
	...
	if (options.surname === void 0) {
		if (options.mode === "surname") options.surname = "all";
	...
	let { list } = getPinyin(word, Array(zhChars.length), options.surname, options.segmentit, options.traditional, zhChars);
	...
	if (multipleList) list = multipleList;
...
//#endregion
//#region ../../node_modules/.pnpm/pinyin-pro@3.29.3/node_modules/pinyin-pro/dist/esm/core/custom/index.mjs
var customDict = {};
...
//#endregion
//#region ../../node_modules/.pnpm/pinyin-pro@3.29.3/node_modules/pinyin-pro/dist/esm/core/dict/index.mjs
...
//#endregion
//#region ../../node_modules/.pnpm/pinyin-pro@3.29.3/node_modules/pinyin-pro/dist/esm/core/match/index.mjs
...
var stripTone = (pinyin) => pinyin.replace(TONE_RE, (ch) => {
	var _a;
...
var matchAny = (text, pinyin, options) => {
	let result = [];
...
var matchAboveStart = (text, pinyin, options) => {
	const words = splitString(text);
	...
	for (let i = 1; i < dp.length; i++) {
		if (!options.continuous || options.space == "ignore" && words[i - 1] === " ") for (let j = 1; j <= pinyin.length; j++) dp[i][j - 1] = dp[i - 1][j - 1];
		for (let j = 1; j <= pinyin.length; j++) if (!dp[i - 1][j - 1]) continue;
			...
			if (words[i - 1] === pinyin[j - 1]) {
				...
				if (j === pinyin.length) return dp[i][j];
			}
			if (pinyin.length - j <= MAX_PINYIN_LENGTH) {
				if (muls.some((py) => {
					if (options.lastPrecision === "any") return py.includes(pinyin.slice(j - 1, pinyin.length));
					if (options.lastPrecision === "start") return py.startsWith(pinyin.slice(j - 1, pinyin.length));
					if (options.lastPrecision === "first") return py[0] === pinyin.slice(j - 1, pinyin.length);
					if (options.lastPrecision === "every") return py === pinyin.slice(j - 1, pinyin.length);
					return false;
			...
			if (precision === "start") muls.forEach((py) => {
				let end = j;
				const matches = [...dp[i - 1][j - 1], i - 1];
				while (end <= pinyin.length && py.startsWith(pinyin.slice(j - 1, end))) {
...
//#endregion
//#region ../../node_modules/.pnpm/pinyin-pro@3.29.3/node_modules/pinyin-pro/dist/esm/core/html/index.mjs
...
//#endregion
//#region ../../node_modules/.pnpm/pinyin-pro@3.29.3/node_modules/pinyin-pro/dist/esm/core/polyphonic/index.mjs
...
//#endregion
//#region ../../node_modules/.pnpm/pinyin-pro@3.29.3/node_modules/pinyin-pro/dist/esm/core/convert/index.mjs
...
//#endregion
//#region ../../node_modules/.pnpm/pinyin-pro@3.29.3/node_modules/pinyin-pro/dist/esm/core/segment/middlewares.mjs
var OutputFormat;
...
//#endregion
//#region ../../node_modules/.pnpm/pinyin-pro@3.29.3/node_modules/pinyin-pro/dist/esm/core/segment/index.mjs
var DEFAULT_OPTIONS = {
	toneType: "symbol",
	mode: "normal",
	nonZh: "spaced",
...
function segment(word, options) {
	...
	const zhChars = splitString(word);
	let { list, matches } = getPinyin(word, Array(zhChars.length), options.surname, options.segmentit, options.traditional, zhChars);
	list = middlewareToneSandhi(list, options.toneSandhi);
	list = middleWareNonZh(list, options);
	middlewareToneType(list, options);
	middlewareV(list, options);

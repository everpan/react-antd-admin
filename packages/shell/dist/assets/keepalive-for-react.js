...
import { Fragment, createContext, memo, startTransition, useCallback, useContext, useEffect, useImperativeHandle, useLayoutEffect, useMemo, useRef, useState } from "react";
...
//#endregion
//#region ../../node_modules/.pnpm/keepalive-for-react@5.0.11_react-dom@19.2.8_react@19.2.8__react@19.2.8/node_modules/keepalive-for-react/dist/index.mjs
function P(e) {
	return e == null;
}
function _(e) {
...
var X = memo(function(e) {
	let { children: t, active: r, refresh: i, destroy: n, destroyAll: o, destroyOther: d, getCacheNodes: E, _cacheKey: m } = e, R = useMemo(() => ({
		active: r,
		refresh: i,
		destroy: n,
		destroyAll: o,
...
function ne(e, t) {
	J(se(e)), e.appendChild(t), t.classList.remove("inactive"), t.classList.add("active");
}
function oe(e, t) {
...
var ae = memo(function(e) {
	let { errorElement: t = Fragment, cacheNodeClassName: r, children: i, cacheKey: n, exclude: o, include: d, enableActivity: E } = e, { active: m, renderCount: R, destroy: L, transition: I, viewTransition: z, duration: g, containerDivRef: O } = e, A = useRef(false);
	...
	return useLayoutEffect(() => {
		...
		o,
		d
	]), A.current ? createPortal(jsx(t, { children: ee && E ? jsx(re, {
		active: m,
		duration: g,
		children: i
	}) : i }), x, n) : null;
...
function _e(e) {
			...
			u((a) => {
				...
				if (a.find((c) => c.cacheKey === t)) return a.map((c) => {
					if (c.cacheKey === t) {
						...
						return y && f.emit("destroy", [t]), {
							...c,
							ele: g,
							lastActiveTime: s,
							renderCount: y ? c.renderCount + 1 : c.renderCount
						};
					}
					return c;
				});
	...
	let D = useCallback((a) => {
		u((s) => {
			let p = a || t;
			return f.emit("refresh", p), s.map((c) => c.cacheKey === p ? {
				...c,
	...
	return useImperativeHandle(O, () => ({
		refresh: D,
		destroy: B,
		destroyAll: G,
		destroyOther: Q,
		getCacheNodes: W
	})), jsxs(Fragment, { children: [jsx("div", {
		ref: v,
		className: m,
		style: { height: "100%" }
	}), l.map((a) => {
...
var Ir = le;
//#endregion
export { je as KeepAlive, We as useEffectOnActive, ot as useEffectOnCreate, b as useKeepAliveContext, le as useKeepAliveRef, Ir as useKeepaliveRef, Ze as useLayoutEffectOnActive, st as useLayoutEffectOnCreate };
